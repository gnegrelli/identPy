...
chosen_estimation1 = "PSO"
chosen_estimation2 = "Trajectory Sensitivity"

chosen_system = "Spring-Mass"  # "Type-3 Wind Turbine"  # "Linearized Load Model Z-IM"  # "Simple Pendulum"  #
...
dic['MVMO']['p_min'] = np.array([0., 0.])
dic['MVMO']['p_max'] = np.array([10., 10.])
...
"""
dic['PSO'] = {}
dic['PSO']['swarm_size'] = 5
dic['PSO']['max_iteration'] = 100
